package edu.arnulfo.ramos.reto5.ui;
import edu.arnulfo.ramos.reto5.process.AdivinarPalabra;
...
public class CLI {
    public static void showMenu() {
        ...
        while (opcion != 0) {
            ...
            if (palabras != null) {
                AdivinarPalabra.jugar(palabras[(int) (Math.random() * palabras.length)]);
            }
        }
